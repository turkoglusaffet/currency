...
public class ExchangeServiceTest {
    ...
    public void setUp() {
        ...
        underTest = new ExchangeService(converterServiceMock,calculatorServiceMock,fixerAccessorMock);
    }
    ...
    public void exchangeSuccess(){
        ...
        //given
        ExchangeResource exchangeRate = underTest.getExchangeRate(CURRENCY_1, CURRENCY_2);


        //then
        Assert.assertEquals(exchangeRate.getFrom(),CURRENCY_1);
        Assert.assertEquals(exchangeRate.getTo(),CURRENCY_2);
        Assert.assertEquals(exchangeRate.getRate().doubleValue(),0.0);
    }
